 ...
 * IDiccionario bajo la clase BSTDiccionario.
 *
 * @author  Uziel Silva Espino
 * @version 25.11.15
 */

public class PruebaBSTDiccionario{
	public static void main(String arg[]){
		...
		IDiccionario<Integer,Integer> d = new BSTDiccionario<Integer,Integer>();
		for(int i = 0; i < 10; i++){
			d.insertar(arreglo[i], arreglo[i]);
		}

		arregloNvo = (((BSTDiccionario<Integer,Integer>)d).getRaiz().regresaInorden(BSTDiccionario.Nodo.LLAVE));

		// Se muestra el resultado al usuario

		System.out.println("Valores finales del arreglo:");
		imprimeArreglo(arregloNvo);
	 ...
	 */
	private static void imprimeArreglo(Object[] arreglo){
		String s = "[";
